...
<body class="g-sidenav-show bg-gray-100">
                ...
                <div class="col-12 px-5">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <h6>Usuario</h6>
                                <select style="width: 100%;" class="form-control" name="idUsuario">
                                    <?php
    ...
    <script>
        ...
        $(document).ready(function() {
            $('select[name=idUsuario]').val('<?=$id?>');
            $('select[name=idUsuario]').on('change input', function() {
                window.location.href = baseUrl + "Assistance/IndexAdmin/" + $(this).val();
            });
        });
    </script>
</body>
